...
<main>
<article class="card">
<header><h1>{{title}}</h1><p class="muted">Informationen zur Anwendung</p></header>
<nav aria-label="Seitennavigation"><a href="/">Start</a><a href="/privacy">Datenschutz</a><a href="/terms">Nutzungsbedingungen</a></nav>
<section id="home" data-page="home"><h2>Start</h2>{{home}}</section>
<section id="privacy" data-page="privacy"><h2>Datenschutzerklärung</h2>{{privacy}}</section>
<section id="terms" data-page="terms"><h2>Nutzungsbedingungen</h2>{{terms}}</section>
{{contactBlock}}
